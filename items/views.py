...
def bag_view(request):
    ...
    trainer_items = TrainerItem.objects.filter(trainer=trainer, quantity__gt=0).select_related("item")
...
def use_item(request, item_id):
    ...
    try:
        trainer_item = TrainerItem.objects.get(trainer=trainer, item_id=item_id, quantity__gt=0)
