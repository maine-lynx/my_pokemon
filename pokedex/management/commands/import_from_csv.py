...
from pokedex.models import Move, Pokemon, PokemonMove, Type
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        moves = []
        with open(moves_path, encoding="utf-8-sig") as f:
        ...
        self.stdout.write(self.style.SUCCESS("✅ 映射就绪"))
        ...
        with open(pm_path, encoding="utf-8-sig") as f:
            reader = csv.DictReader(f)
            for row in reader:
